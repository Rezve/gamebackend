                        ...
                        <table class="gameview" align="center">
                          <tbody value='question'>
                           ...
                           <tr>
                           @foreach($game->question->ten as  $key => $value)
                              <td>{{ $value }}</td>
                           @endforeach
                           </tr>
                           <tr>
                           @foreach($game->question->eleven as  $key => $value)
                              <td>{{ $value }}</td>
                           @endforeach
                           </tr>
                        ...
                        <table class="gameview" align="center">
                          <tbody value='answer'>
                           ...
                           <tr>
                           @foreach($game->answer->ten as  $key => $value)
                              <td>{{ $value }}</td>
                           @endforeach
                           </tr>
                           <tr>
                           @foreach($game->answer->eleven as  $key => $value)
                              <td>{{ $value }}</td>
                           @endforeach
                           </tr>
